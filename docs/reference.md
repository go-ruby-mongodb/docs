...
The public API lives at the module root (`github.com/go-ruby-mongodb/mongodb`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `mongodb`, while the surface follows
...
```go
import "github.com/go-ruby-mongodb/mongodb"
```
...
- **[pkg.go.dev/github.com/go-ruby-mongodb/mongodb](https://pkg.go.dev/github.com/go-ruby-mongodb/mongodb)**

The module's [README](https://github.com/go-ruby-mongodb/mongodb#readme) carries worked
